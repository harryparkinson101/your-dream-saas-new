...
import { Color, Scene, Fog, PerspectiveCamera, Vector3, AmbientLight } from "three";
...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  }, [globeRef.current, globeConfig, themeMode]);
  ...
  const _buildMaterial = () => {
    ...
    globeMaterial.specular = new Color("#ffffff");
  };
...
export function World(props: WorldProps) {
  ...
  scene.fog = new Fog(0x000000, 400, 2000); // Darker fog color for better contrast

  return (
    <Canvas scene={scene} camera={new PerspectiveCamera(50, aspect, 180, 1800)}>
      <WebGLRendererConfig />
      <ambientLight color={globeConfig.ambientLight || "#ffffff"} intensity={0.7} /> 
      <pointLight
        color={globeConfig.pointLight || "#ffffff"}
        position={new Vector3(200, 400, 300)}
        intensity={1.8}
        distance={800}
        decay={2}
      />
