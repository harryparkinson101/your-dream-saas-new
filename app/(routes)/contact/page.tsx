...
export default function Contact() {
  ...
  const [globeConfig, setGlobeConfig] = useState({
    pointSize: 4,
    globeColor: themeMode === 'dark' ? "#062056" : "#00b9ff",
    showAtmosphere: true,
    atmosphereColor: themeMode === 'dark' ? "#FFFFFF" : "#171616",
    atmosphereAltitude: 0.3,
    emissive: themeMode === 'dark' ? "#062056" : "#aaaaaa",
    emissiveIntensity: 0.1,
    shininess: 0.9,
    polygonColor: themeMode === 'dark' ? "rgba(255,255,255,0.7)" : "rgba(0,0,0,0.7)",
    ambientLight: themeMode === 'dark' ? "#38bdf8" : "#999999",
  ...
  // Update globeConfig when themeMode changes
  useEffect(() => {
  ...
  }, [themeMode]); // Dependency on themeMode 
  ...
  return (
    <div className="relative w-full h-screen flex flex-col  items-center  pt-8 bg-gray-600 dark:bg-black">
      <div className="mb-12">
        <h1 className="text-3xl font-extrabold text-white dark:text-gray-100 text-center">
        ...
        <div className=" w-3/4 items-center flex justify-center">
          <div className="relative z-10  w-3/4 h-fit mt-0 md:rounded-2xl p-4 md:p-8 bg-gray-100 dark:bg-black drop-shadow-[0_0_5px_rgba(255,255,255,0.7)] dark:shadow-blue-700 shadow-lg shadow-pink-700 rounded-xl transition-all ease-in-out duration-300">
            ...
            <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300 pb-2">
              Use the form below to share your project details. I'm here to help you build a website that stands out and meets your goals.
            </p>
